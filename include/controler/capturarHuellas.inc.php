...
require_once FOLDER_MODEL . "WSAware/fingerPrint/WSAwareFingerPrint.inc.php";
...
function guardarHuella($key,$estatus,$base64)
{
    global $objSession;
    $r = new xajaxResponse();
    ...
    if ($estatus=='disponible'){
        ...
        $dir_subida = $persona->getPathIdentidadHuellas();
    }
